...
int main(){
    ...
    particles.addRule(Rule(colorToStr(sf::Color::Green), colorToStr(sf::Color::Green), 0.7));
    particles.addRule(Rule(colorToStr(sf::Color::Yellow), colorToStr(sf::Color::Green), -0.5));
    particles.addRule(Rule(colorToStr(sf::Color::Green), colorToStr(sf::Color::Yellow), 0.7));
    particles.addRule(Rule(colorToStr(sf::Color::Green), colorToStr(sf::Color::Blue), 0.8));
